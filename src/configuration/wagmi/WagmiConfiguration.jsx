...
const WagmiConfiguration = (props) => {
  ...
  const projectId = process.env.REACT_APP_WAGMI_PROJECTID;
        ...
        >
          <Web3Modal
            ...
            themeVariables={{
              ...
              "--w3m-logo-image-url": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Bitcoin.svg/220px-Bitcoin.svg.png", // logo image url
